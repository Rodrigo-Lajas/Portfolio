import houstonguitarshop from 'src/assets/houstonguitarshop.png';
import tiendaDeGuitarras from 'src/assets/tiendaDeGuitarras.png';
import tiendaDeCelulares from 'src/assets/tiendaDeCelulares.png';
const Proyects = [
    {
        id: 1,
